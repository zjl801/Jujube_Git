package com.bgi.supervision.jujubeutils.j_log

import android.util.Log
import com.bgi.supervision.jujubelog.handler.*
import com.bgi.supervision.jujubelog.log.handler.BundleHandler
...
object L {
    ...
    @JvmStatic
    var logLevel = L.LogLevel.DEBUG // 日志的等级，可以进行配置，最好在Application中进行全局的配置
    ...
    @JvmStatic
    fun e(msg: String?) {
        if (L.LogLevel.ERROR.value <= logLevel.value) {
    ...
    @JvmStatic
    fun w(msg: String?) {
        if (L.LogLevel.WARN.value <= logLevel.value) {
    ...
    @JvmStatic
    fun i(msg: String?) {
        if (L.LogLevel.INFO.value <= logLevel.value) {
    ...
    @JvmStatic
    fun d(msg: String?) {
        if (L.LogLevel.DEBUG.value <= logLevel.value) {
