...
public final class ImageUtil {
    ...
    public static Bitmap drawable2Bitmap(@DrawableRes int resId) {
        Drawable drawable = ContextCompat.getDrawable(jUtils.getApp(), resId);
    ...
    public static Bitmap getBitmap(@DrawableRes int resId, int maxWidth, int maxHeight) {
        ...
        final Resources resources = jUtils.getApp().getResources();
    ...
    public static Drawable bitmap2Drawable(Bitmap bitmap) {
        return bitmap == null ? null : new BitmapDrawable(jUtils.getApp().getResources(), bitmap);
    }
    ...
    public static Bitmap stackBlurByRS(Bitmap src, @IntRange(from = 0, to = 25) int radius) {
        if (src == null) return null;
        return blur(jUtils.getApp(), src, radius);
    }
    ...
    public static Bitmap blur(Context context, Bitmap blurredBitmap, @IntRange(from = 0, to = 25) int radius) throws RSRuntimeException {
        try {
            ...
            blurredBitmap = blur(blurredBitmap, radius, true);
        }
