 ...
 * Describe:
 */
public class BGIPhotoPickerPreviewActivity extends BGIPPToolbarActivity implements PhotoViewAttacher.OnViewTapListener {
    ...
    public static class IntentBuilder {
        ...
        public IntentBuilder(Context context) {
            mIntent = new Intent(context, BGIPhotoPickerPreviewActivity.class);
        }
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        ArrayList<String> previewPhotos = BGIPhotoPickerActivity.imageList;
