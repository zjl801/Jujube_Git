...
import com.bgi.photopicker.adapter.BGIPhotoPickerAdapter;
import com.bgi.photopicker.model.BGIPhotoFolderModel;
import com.bgi.photopicker.util.BGIPhotoHelper;
...
import com.bgi.photopicker.imageloader.BGIRVOnScrollListener;
import com.bgi.photopicker.pw.BGIPhotoFolderPw;
import com.bgi.photopicker.util.BGIAsyncTask;
import com.bgi.photopicker.util.BGILoadPhotoTask;
 ...
 * Describe:
 */
public class BGIPhotoPickerActivity extends BGIPPToolbarActivity implements BGAOnItemChildClickListener, BGIAsyncTask.Callback<ArrayList<BGIPhotoFolderModel>> {
    ...
    private BGIPhotoFolderModel mCurrentPhotoFolderModel;
     ...
     * 图片目录数据集合
     */
    private ArrayList<BGIPhotoFolderModel> mPhotoFolderModels;

    private BGIPhotoPickerAdapter mPicAdapter;

    private BGIPhotoHelper mPhotoHelper;

    private BGIPhotoFolderPw mPhotoFolderPw;

    private BGILoadPhotoTask mLoadPhotoTask;
    ...
    public static class IntentBuilder {
        ...
        public IntentBuilder(Context context) {
            mIntent = new Intent(context, BGIPhotoPickerActivity.class);
        }
    ...
    protected void setListener() {
        mPicAdapter = new BGIPhotoPickerAdapter(mContentRv);
        mPicAdapter.setOnItemChildClickListener(this);

        if (getIntent().getBooleanExtra(EXTRA_PAUSE_ON_SCROLL, false)) {
            mContentRv.addOnScrollListener(new BGIRVOnScrollListener(this));
        }
    }
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        if (cameraFileDir != null) {
            ...
            mPhotoHelper = new BGIPhotoHelper(cameraFileDir);
        }
        // 获取图片选择的最大张数
    ...
    protected void onStart() {
        ...
        showLoadingDialog();
        mLoadPhotoTask = new BGILoadPhotoTask(this, this, mTakePhotoEnabled).perform();
    }
    ...
    private void showPhotoFolderPw() {
        ...
        if (mPhotoFolderPw == null) {
            mPhotoFolderPw = new BGIPhotoFolderPw(this, mToolbar, new BGIPhotoFolderPw.Delegate() {
                @Override
                ...
                public void executeDismissAnim() {
                    ViewCompat.animate(mArrowIv).setDuration(BGIPhotoFolderPw.ANIM_DURATION).rotation(0).start();
                }
            });
        }
        ...
        ViewCompat.animate(mArrowIv).setDuration(BGIPhotoFolderPw.ANIM_DURATION).rotation(-180).start();
    }
    ...
    private void toastMaxCountTip() {
        BGIPhotoPickerUtil.show(getString(R.string.bga_pp_toast_photo_picker_max, mMaxChooseCount));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_CODE_TAKE_PHOTO) {
                ...
                Intent photoPickerPreview = new BGIPhotoPickerPreviewActivity.IntentBuilder(this)
                ...
                if (BGIPhotoPickerPreviewActivity.getIsFromTakePhoto(data)) {
                    // 从拍照预览界面返回，刷新图库
                    mPhotoHelper.refreshGallery();
                }
                returnSelectedPhotos(BGIPhotoPickerPreviewActivity.getSelectedPhotos(data));
            }
            ...
            if (BGIPhotoPickerPreviewActivity.getIsFromTakePhoto(data)) {
                ...
                mPicAdapter.setSelectedPhotos(BGIPhotoPickerPreviewActivity.getSelectedPhotos(data));
                renderTopRightBtn();
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        BGIPhotoHelper.onSaveInstanceState(mPhotoHelper, outState);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        BGIPhotoHelper.onRestoreInstanceState(mPhotoHelper, savedInstanceState);
    ...
    private void takePhoto() {
        try {
            ...
            BGIPhotoPickerUtil.show(R.string.bga_pp_not_support_take_photo);
        }
    }
    ...
    private void changeToPreview(int position) {
        ...
        imageList = (ArrayList<String>) mPicAdapter.getData();
        Intent photoPickerPreviewIntent = new BGIPhotoPickerPreviewActivity.IntentBuilder(this)
//                .previewPhotos((ArrayList<String>) mPicAdapter.getData())
    ...
    @Override
    public void onPostExecute(ArrayList<BGIPhotoFolderModel> photoFolderModels) {
